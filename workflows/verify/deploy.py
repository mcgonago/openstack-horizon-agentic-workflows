...
def _deploy_before_local(verify_dir, state, args):
    ...
    _write_local_settings_file(checkout_dir, angular_keypairs=True)
...
def _deploy_after_local(verify_dir, state, args):
    ...
    _write_local_settings_file(checkout_dir, angular_keypairs=False)
...
def _write_local_settings_file(checkout_dir, angular_keypairs=False):
