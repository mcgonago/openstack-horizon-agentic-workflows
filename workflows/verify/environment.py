...
def setup_environment(verify_dir, state, args):
    ...
    if use_virtctl:
        ...
        openrc = virtctl_config.get("openrc", "~/devstack/openrc admin demo")
        ...
        openrc = env_config.get("openrc", "")
        conn = DevStackConnection(host, openrc=openrc)
    ...
    if use_virtctl:
        ...
        state["devstack_connection"] = {"mode": "ssh", "host": host, "user": "stack", "openrc": openrc}
